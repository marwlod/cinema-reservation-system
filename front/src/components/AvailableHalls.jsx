...
import {buildUrl, callCrsApi, availableCinemaHallsUrl, loggedInClient, hallCheckDate} from "./ApiUtils";
...
export default function AvailableHalls(props) {
    ...
    function getFreeSeats() {
        const url = buildUrl(availableCinemaHallsUrl, [], {"clientId": loggedInClient, "date": hallCheckDate})
